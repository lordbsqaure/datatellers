  ...
  const Createuser = async () => {
    ...
    if (newfirsttime === "Yes") {
      ...
      if (users.length < 10) {
        ...
        newcode =
          "A" + users.length + "" + arrays[2] + "" + arrays[1] + "" + arrays[0];
      }
    } else {
      if (code == "") {
        ...
        const someone = users.filter((data) => {
          if (data.code == newcode) {
            if (
              data.email.toLowerCase() !== newemail ||
              data.name.toLowerCase() !== newname.toLocaleLowerCase ||
              data.sex.toLowerCase() !== newsex ||
              data.age.toLowerCase() !== newage
            ) {
              console.log("hello");
    ...
    <>
      <div className=" background">
        ...
        <div className="container-fluid">
          ...
          <div className="row">
            <div className="col"> </div>{" "}
            <div className="col-1 from-control ">
              {" "}
              unique code:{" "}
              <input
                readOnly={false}
            ...
            <div className="col-2 ">
              ...
              <select
                ...
                id="sex"
                value={
                  params.id && newindividual.length > 0
                    ? newindividual[0].sex
                    : ""
                }
                onChange={(event) => {
          ...
          <div className="row">
            <div className="col"> </div>{" "}
            <div className="col-2 from-control ">
              {" "}
              Appointment date{" "}
              <input
                type="date"
            ...
            <div className="col-2 ">
              ...
              <select
                ...
                id="firsttime"
                onChange={(event) => {
                  setnewfirsttime(event.target.value);
                }}
              >
                {" "}
            ...
            <div className="col-3 ">
              ...
              >
                <option> pending </option> <option> rescheduled </option>{" "}
                <option> missed </option> <option> passed </option>{" "}
              </select>{" "}
            </div>{" "}
            <div className="col-2  ">
              {" "}
          ...
          <div className="row">
            <div className="col"> </div>{" "}
            <div className="col-3 from-control ">
              {" "}
              Address 1{" "}
              <input
                type="text"
            ...
            <div className="col-6"> </div> <div className="col"> </div>
          </div>
          <div className="row my-4">
            <div className="col"> </div>{" "}
          ...
          <div className="row">
            ...
            <div className="col-3 from-control ">
              ...
              <textarea
                ...
                id="before"
                onChange={(event) => {
                  setnewbefore(event.target.value);
                }}
              />
            </div>
            <div className="col-2">
              ...
              <textarea
                ...
                id="after"
                onChange={(event) => {
                  setnewafter(event.target.value);
                }}
              />{" "}
            </div>{" "}
            <div className="col-6"> </div> <div className="col"> </div>
